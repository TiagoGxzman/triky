...
fondo = pygame.image.load('Resources/tictactoe_background.png')
circulo = pygame.image.load('Resources/circle.png')
ekis = pygame.image.load('Resources/x.png')

fondo = pygame.transform.scale(fondo, (450,450))
circulo = pygame.transform.scale(circulo, (125,125))
ekis = pygame.transform.scale(ekis, (125,125))
...
def dibujar_x(fila,col):
    screen.blit(ekis, coor[fila][col])
